...
''' <summary>
''' Helpers de bajo nivel para construir reportes .docx con DocumentFormat.OpenXml (sin dependencia
''' de Word instalado), replicando la receta de estilos extraída de la plantilla EstrucMed de referencia
...
''' Usado por <see cref="ReporteRevisionService"/> y por <see cref="InformeEstadoMurosService"/>.
''' </summary>
Public Module ReporteRevisionWordHelpers
    ...
    Public Function ImagenCentrada(mainPart As MainDocumentPart, pngBytes As Byte(), anchoCm As Double, altoCm As Double) As Paragraph
        ...
        ) With {.Uri = "http://schemas.openxmlformats.org/drawingml/2006/main"}
